<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if ($username =="" || $password=="")
        {
            ...
            header('refresh:3; url=http://localhost/07/login.html');
        }
        else
        {
...

            {
                ...
                header('refresh:2; url=http://localhost/07/dashboard.php');
            }
            else
            {
                echo "Login failed";
                header('refresh:2; url=http://localhost/07/login.html');
            }
